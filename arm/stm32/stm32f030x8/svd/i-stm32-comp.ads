...
package Interfaces.STM32.COMP is
   ...
   subtype CSR_COMP1EN_Field is Interfaces.STM32.Bit;
   subtype CSR_COMP1_INP_DAC_Field is Interfaces.STM32.Bit;
   subtype CSR_COMP1MODE_Field is Interfaces.STM32.UInt2;
   subtype CSR_COMP1INSEL_Field is Interfaces.STM32.UInt3;
   subtype CSR_COMP1OUTSEL_Field is Interfaces.STM32.UInt3;
   subtype CSR_COMP1POL_Field is Interfaces.STM32.Bit;
   subtype CSR_COMP1HYST_Field is Interfaces.STM32.UInt2;
   subtype CSR_COMP1OUT_Field is Interfaces.STM32.Bit;
   subtype CSR_COMP1LOCK_Field is Interfaces.STM32.Bit;
   subtype CSR_COMP2EN_Field is Interfaces.STM32.Bit;
   subtype CSR_COMP2MODE_Field is Interfaces.STM32.UInt2;
   subtype CSR_COMP2INSEL_Field is Interfaces.STM32.UInt3;
   subtype CSR_WNDWEN_Field is Interfaces.STM32.Bit;
   subtype CSR_COMP2OUTSEL_Field is Interfaces.STM32.UInt3;
   subtype CSR_COMP2POL_Field is Interfaces.STM32.Bit;
   subtype CSR_COMP2HYST_Field is Interfaces.STM32.UInt2;
   subtype CSR_COMP2OUT_Field is Interfaces.STM32.Bit;
   subtype CSR_COMP2LOCK_Field is Interfaces.STM32.Bit;
